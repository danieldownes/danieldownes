...
export default function Intro() {
  ...
  return (
    ...
    >
        ...
        <div className="relative">
          ...
          >
            <Image
              ...
              quality="95"
              priority={true}
              className="h-30 w-30 rounded-full object-cover border-[0.25rem] border-white shadow-xl"
            />
          </motion.div>
      ...
      <motion.div
        className="flex flex-col sm:flex-row items-center justify-center gap-6 px-2 text-lg font-medium"
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{
          delay: 0.1,
